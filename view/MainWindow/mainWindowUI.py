...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.videoCaptureLabel_2 = QLabel(self.verticalLayoutWidget_2)
        self.videoCaptureLabel_2.setObjectName(u"videoCaptureLabel_2")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Ignored)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.videoCaptureLabel_2.sizePolicy().hasHeightForWidth())
        self.videoCaptureLabel_2.setSizePolicy(sizePolicy3)
        self.videoCaptureLabel_2.setMinimumSize(QSize(78, 68))
        self.videoCaptureLabel_2.setSizeIncrement(QSize(0, 0))
        self.videoCaptureLabel_2.setFrameShape(QFrame.Shape.Box)
        self.videoCaptureLabel_2.setFrameShadow(QFrame.Shadow.Sunken)
        self.videoCaptureLabel_2.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_3.addWidget(self.videoCaptureLabel_2)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.videoCaptureLabel_2.setText("")
